...
import com.twg.springboot.mydiary.service.UserDairyService;
...
public class HomeController {
	...
	@Autowired
	private UserDairyService userService; 
	
	@Autowired
	HttpSession session;
	
	
	public UserDairyService getUserService() {
		return userService;
	}


	public void setUserService(UserDairyService userService) {
