...
/*	@GetMapping
	...
	*/
	//@GetMapping("/api/v1/posts")
//	@GetMapping("/api/v1/posts/{id}")	 //version from request URI
//	@GetMapping(value ="/api/posts/{id}" , params = "version=1")    //version from Query Params 
//	@GetMapping(value ="/{id}" , headers = "X-API_VERSION=1") 
	@GetMapping(value ="/{id}" , produces = "application/uday.v1+json") 
...
//	@GetMapping(value = "/{id}" , headers = "X-API_VERSION=2")
	@GetMapping(value = "/{id}" ,  produces = "application/uday.v2+json")
